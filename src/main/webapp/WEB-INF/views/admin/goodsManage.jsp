                			...
                			<table class="goods_table">
                				<thead>
                					<tr>
                						...
                						<td class="th_column_5">등록 날짜</td>
                					</tr>
                				</thead>
                			<c:forEach items = "${list }" var="list">
                			<tr>
                				<td><c:out value="${list.goodsCode }"></c:out></td>
                				<td>
                					<a class="move" href="<c:out value="${list.goodsCode }"/>">
                						<c:out value="${list.goodsName }"></c:out>
                					</a>
                				<td><c:out value="${list.goodsCate }"></c:out></td>
...
$(document).ready(function(){
	...
	$(".move").on("click", function(e){
		...
		moveForm.append("<input type='hidden' name='goodsCode' value='"+$(this).attr("href")+"'>");
