		...
		<div class="wrap">
			...
			<div class="user_wrap">
				...
				<div class="user_input_box">
					<input class="user_input" name="memberName" placeholder="${member.memberName}">
				</div>
			...
			<div class="tel_wrap">
				...
				<div class="tel_input_box">
					<input class="tel_input" name="memberTel" placeholder="${member.memberTel}">
				</div>
			...
			<div class="mail_wrap">
				...
				<div class="mail_input_box">
					<input class="mail_input" name="memberMail" placeholder="${member.memberMail}">
				</div>
			...
			<div class="address_wrap">
				...
				<div class="address_input_box">
					<div class="address_input_1_box">
						<input class="address_input_1" name="memberAddr1" placeholder="${member.memberAddr1}" readonly="readonly">
					</div>
				...
				<div class="address_input_2_wrap">
					<div class="address_input_2_box">
						<input class="address_input_2" name="memberAddr2" placeholder="${member.memberAddr2}" readonly="readonly">
					</div>
				</div>
				<div class="address_input_3_wrap">
					<div class="address_input_3_box">
						<input class="address_input_3" name="memberAddr3" placeholder="${member.memberAddr3}" readonly="readonly">
					</div>
					<span class="final_addr_ck">주소를 입력해주세요.</span>
				</div>
			</div>
			<div class="join_button_wrap" style="font-family: 'NanumSquare'">
				<input type="button" class="join_button" value="회원정보수정">
				<input type="button" class="cancel_button" value="취소" onClick="location.href='/orderList'">
			</div>
		</div>
	</form>
	</c:if>
...
$(document).ready(function(){
	...
	$(".join_button").click(function(){
		...
		if(pwCheck&&pwckCheck&&pwckcorCheck&&nameCheck&&telCheck&&mailCheck&&addressCheck ){	
			$("#modify_form").attr("action", "/member/updateMember");
			$("#modify_form").submit();
		}
		return false;
	})
