...
<!--<inout type="hidden" id="me_id_yn" name="me_id_yn" value="N">  -->
...
<div class="row">
<div class="col-lg-6 d-lg-block bg-password-image"></div>
<div class="col-lg-6">
<div class="p-5">
	...
	<div class="text-center">
		<a class="small" href="/member/login">Already have account? Login!</a>
	</div>
</div>
</div>
</div>
